...
public class Complaint extends Post{
    ...
    public Complaint(String content, User author){
        super(content, author);
        this.urgencyLevel = Urgency.LOW;
        this.student = student;
    }

    public Complaint(String content, User author, Urgency urgencyLevel){
        super(content, author);
    ...
    public String toString() {
        return (urgencyLevel==Urgency.HIGH?"\uD83D\uDFE5":(urgencyLevel==Urgency.MIDDLE?"🟨":"🟩")) +"\t" + super.toString() + "\n\tstudent:" + student;
    }
}
